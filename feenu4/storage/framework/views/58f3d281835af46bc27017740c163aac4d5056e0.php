                ...
                <div class="card-body">
                    <form action="" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="link" name="link" value="<?php if(!empty($game)): ?><?php echo e($game->link); ?><?php endif; ?>" required>
                        </div>
                        <div class="mb-3">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\feenu\resources\views/admin/games_add.blade.php ENDPATH**/ ?>