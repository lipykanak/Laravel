                ...
                <div class="card-body">
                    <form action="" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="Description" name="Description" value="<?php if(!empty($about)): ?><?php echo e($about->Description); ?><?php endif; ?>" required>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\feenu3023\resources\views/admin/about_add.blade.php ENDPATH**/ ?>