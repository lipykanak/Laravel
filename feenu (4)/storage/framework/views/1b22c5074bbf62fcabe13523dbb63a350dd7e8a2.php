                     ...
                     <?php endif; ?>
                         <form method="POST" action="<?php echo e(route('login')); ?>">
                            <?php echo csrf_field(); ?>
                             ...
                             <?php endif; ?>
                              <div class="float-right ">Don't have an account  <a class="float-right" href="<?php echo e(('/register')); ?>">  Sign Up</a></div> 
                             </div>
                             </div> <!-- form-group// -->
                             <div class="form-group">
...
<?php echo $__env->make('frontend.Layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\feenu\resources\views/auth/login.blade.php ENDPATH**/ ?>